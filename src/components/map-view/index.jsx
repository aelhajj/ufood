...
class Map extends Component {
	...
	static defaultProps = {
		googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyCKC_4Y4NwiHHobVhoDzCbuk69cY-QU9lk&v=3.exp&libraries=geometry,drawing,places",
	}
			...
			<Fragment>
				...
				>
		
						{
							places.map((e, index) => (
								<Marker key={index}
									position={{ lat: e.location.coordinates[1], lng: e.location.coordinates[0] }}
								...
								>
									{
										...
										<InfoWindow
											...
											<div className='infoWindowView'>
												<div>
    												<img className='markerImg' alt='img' src={e.pictures[0]} />
												</div>
												<div className='markerText'>
													...
													>
														<p className='textClickable' style={{ fontSize: '15px',  color: 'white' }} > View Details </p>
													</Link>
												</div>
											</div>
										</InfoWindow>
